  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.downview}>
        <View style={{flexDirection:'row',marginLeft:10,marginRight:40}}>
      <TextInput style={{marginTop:36,height:52,width:65,marginLeft:30,backgroundColor:'#F4F4FC',textAlign:'center',borderRadius:8}}
       ...
       keyboardType='number-pad'
        ...
        if(v != ''){
         ...
         value={this.state.t1}
      />
      <TextInput style={{marginTop:36,height:52,width:65,marginLeft:22,backgroundColor:'#F4F4FC',textAlign:'center',borderRadius:8}}
      ref={'t2ref'}
      keyboardType='number-pad'
        maxLength={1}
        onChangeText={(v) => {this.setState({ t2: v })
        if(v != ''){
          this.refs.t3ref.focus()
        }
        }}
         value={this.state.t2}
        />
